...
public class UserResourceFunctionalTesting {
    ...
    public void testModifyActiveOfUser () {
        ...
        assertEquals("{\"id:\"1,\"name\":\"David\",\"active\":\"false\"}", new HttpClientService().httpRequest(request).getBody());        	
    }
    ...
    public void testAddSportToUser () {
        ...
        assertEquals("{\"id\":1,\"name\":\"David\",\"active\":\"true\", \"sport\":[{\"title\":\"tennis\", \"category\":\"junior\"}]}", response);        
    }
}
